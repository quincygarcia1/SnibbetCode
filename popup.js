...
function createSection(link, Title, Snippet, keyValue) {
    ...
    var buttonDiv = document.createElement("div")
    ButtonCreator("controlbuttons removeBtn", "Remove", buttonDiv, link)
    ButtonCreator("controlbuttons goToBtn", "Go To Source", buttonDiv, link)
...
function ButtonCreator(classTitle2, inner, appendsection, openLink){
